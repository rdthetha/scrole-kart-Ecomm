...
<div className="ec-wishlist-content">
    ...
    <div className="card-container" key={item.id}>
        ...
        <div className="card-details">
            ...
            {cart.some(p=>p.id===item.id)?(<Link to="/Cart"><button className="btn-primary btn-outline-primary btn-card">Go to cart</button></Link>):(<button onClick={()=>{dispatch({type:"ADD_TO_CART",payload:item});wishDispatch({type:"DELETE_FROM_WISHLIST",payload:item})}}className="btn-primary btn-outline-primary btn-card">Move to cart</button>)}
